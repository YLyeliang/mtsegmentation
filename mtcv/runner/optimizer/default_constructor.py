...
from mtcv.utils import build_from_cfg, is_list_of
...
class DefaultOptimizerConstructor:
    ...
    def _validate_cfg(self):
        ...
        if 'custom_keys' in self.paramwise_cfg:
            if not isinstance(self.paramwise_cfg['custom_keys'], dict):
                raise TypeError(
                    ...
                    f'but gt {type(self.paramwise_cfg["custom_keys"])}')
        ...
        # weight_decay must be  explicitly specified if ult is specified.
        if (
